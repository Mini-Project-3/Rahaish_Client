    ...
    return (
        <div>
            ...
            <div className="sm:w-1/2 w-full">
                ...
                <h1 className=" font-semibold text-xl text-red-500 pt-4 pb-4">Our Vision</h1>
                <p className=" pb-4 text-gray-700">Delivering trustworthy experiences that you cherish for a lifetime.</p>
                <h1 className=" text-xl font-semibold text-red-500 pb-4">Our Mission</h1>
