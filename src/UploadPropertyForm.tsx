...
const UploadPropertyForm: FC<Props> = (props) => {
    ...
    return (
        <div className="flex space-x-4 font-mono ">
            <div className="invisible md:visible absolute md:relative  w-1/2 mx-auto  mt-10  "><img className=" p-10 h-full" src="https://profiles.sulekha.com/mstore/24036103/albums/default/thumbnailfull/flats.jpg" alt="" /></div>
            <section className="max-w-2xl  md:p-5 w-full md:w-1/2 mx-auto md:pl-6  bg-secondary rounded-md shadow-md dark:bg-gray-800 mt-4">
                <h1 className=" font-semibold text-2xl text-center text-gray-700 capitalize dark:text-white">Upload Your Property</h1>
                <form className="  p-2 md:p-4" onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 mx-auto gap-3 mt-4 sm:grid-cols-2">
                        <div>
                            <label className=" text-sm font-bold text-gray-700" >Rent or Sale</label>
                            <input id="type" required {...getFieldProps("type")} type="text" className="block w-full px-3 py-2 hover:shadow-md  text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" placeholder="Sale or Rent" />
                        </div>
                        ...
                        <div>
                            <label className=" text-sm font-bold text-gray-700" >Progress</label>
                            <input id="progress" required {...getFieldProps("progress")} type="number" className="block w-full px-3 py-2  hover:shadow-md  text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" placeholder="Completed  or under construction or furnished" />
                        </div>
                        <div>
                            <label className=" text-sm font-bold text-gray-700" >Facing Direction</label>
                            <input id="direction" required {...getFieldProps("direction")} type="text" className="block w-full px-3 py-2 hover:shadow-md  text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" placeholder="Facing direction" />
                        </div>
                        ...
                        <div>
                            ...
                            <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                <div className="space-y-1 text-center">
                                    ...
                                    <p className="text-xs text-sm font-bold text-gray-700">
...
UploadPropertyForm.defaultProps = {
}
export default memo(UploadPropertyForm);
export { };