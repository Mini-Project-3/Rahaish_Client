...
return (
 <div className="">
<div className="p-5 w-full max-w-lg border-0 rounded-lg shadow-lg ">
...
<div className="border-2  w-full  h-96 rounded-lg p-6 shadow-lg pt-2 ">
...
<input className="font-bold mt-1" type="checkbox" name="" id=""/>
<div className="">
...
<button className="border-0 border-gray- bg-gray-500 h-14 w-full hover:bg-blue-800 ">
