...
const PlotDetailsForm: FC<Props> = (props) => {
    ...
    return (
        <div className="flex space-x-4 font-mono ">
            <div className="invisible md:visible absolute md:relative  w-1/2 mx-auto  mt-10  "><img className=" p-10 h-full" src="https://www.novalifespace.in/blog/wp-content/uploads/2020/07/plots-for-sale-in-ayanambakkam.jpeg" alt="" /></div>
...
PlotDetailsForm.defaultProps = {
}
export default memo(PlotDetailsForm);