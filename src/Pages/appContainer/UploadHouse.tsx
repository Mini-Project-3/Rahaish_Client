...
const UploadHouse: FC<Props> = (props) => {
    ...
    return (
        <div className="flex space-x-4 mx-auto justify-center font-mono ">
            <div className="invisible lg:visible absolute lg:relative  w-1/2 mx-auto  mt-10  "><img className="p-10 h-full" src="https://profiles.sulekha.com/mstore/24036103/albums/default/thumbnailfull/flats.jpg" alt="" /></div>
