            ...
            <div className="flex justify-between bg-black p-3 ">
                ...
                <div className="flex space-x-4 items-center ">
                        <div>
                            ...
                            <div className=" absolute mt-5 -ml-10">{isOpen1 && <DropDown></DropDown>}</div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className=" absolute mt-5 -ml-16 ">{ isOpen2  && <DropDown></DropDown>}</div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className=" absolute mt-5 -ml-20  ">{ isOpen3 && <DropDown></DropDown>}</div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className=" absolute mt-5 -ml-28 ">{isOpen4  && <DropDown></DropDown>}</div>
                        </div>
