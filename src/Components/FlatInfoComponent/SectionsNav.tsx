...
const SectionsNav: FC<Props> = (props) => {
    return (
        <div className=" ">
            <div className=" border-t-2 invisible absolute md:relative z-20 bg-white  top-0 md:visible  border-b-2 border--gray-300 text-lg font-medium flex flex-col md:flex-row  list-none md:space-x-8 uppercase p-2 md:p-6 justify-center">
