    ...
    <div>
      <div className="flex  flex-col  sm:flex-row justify-center p-14 bg-gray-50  ">
        <div className="text-center">
          ...
          <p className="border-2 rounded-full md:w-11 md:p-2 md:h-11 h-8 w-8 px-1 py-0   bg-primary text-white mx-auto animate-bounce  ">1</p>
        ...
        <div>
          ...
          <p className="border-2 rounded-full md:w-11 md:px-4 md:py-2 md:h-11 h-8 w-8 px-3 py-0 pl-3 mx-auto  bg-primary text-white  animate-bounce">2</p>
        ...
        <div>
          ...
          <p className="border-2 rounded-full md:w-11 md:px-4 md:py-2 md:h-11 h-8 w-8 px-3 py-0 pl-3   bg-primary text-white mx-auto animate-bounce">3</p>
        ...
        <div className=" invisible md:invisible lg:visible absolute md:absolute lg:relative ">
          ...
          <p className="border-2 rounded-full md:w-11 md:px-4 md:py-2 md:h-11 h-8 w-8 px-3 py-0 pl-3 bg-primary text-white mx-auto animate-bounce">4</p>
