...
const Jumbotron1: FC<Props> = (props) => {
    return (
        <>
            <div>
                <div className="flex justify-center items-center mx-auto w-10/12 h-full bg-secondary">
                    <div className="container mx-auto mt-10 mb-10 lg:mb-40 lg:px-20">
                        ...
                        <div className="relative w-full lg:-mt-96 lg:w-3/6 p-8 ml-auto bg-primary rounded-2xl z-50">
