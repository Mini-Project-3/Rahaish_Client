                ...
                <div className="items-center flex flex-wrap">
                    ...
                    <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
                        <div className="md:pr-12">
                            <div className="text-purple-900 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-purple-300 mt-8">
                            ...
                            <ul className="list-none mt-4">
                                <li className="py-1">
                                    <div className="flex items-center">
                                        <div>
                                            <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-purple-800 bg-purple-300 mr-3"><AiFillCaretRight></AiFillCaretRight></span>
                                        </div>
                                        <div>
