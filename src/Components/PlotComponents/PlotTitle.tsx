...
const PlotTitle: FC<Props> = (props) => {
    return (
        <div className=" ">
            ...
            <div className=" flex flex-col md:flex-row  md:justify-between px-20 py-10 text-center justify-center">
                ...
                <div className="  p-2 md:p-5">
                    <h1 className=" text-base ">{props.openFaces}</h1>
                    <p className="text-lg font-medium">Open Faces</p>
                </div>
            </div>
        </div>
    );
};
PlotTitle.defaultProps = {
}
export default memo(PlotTitle);