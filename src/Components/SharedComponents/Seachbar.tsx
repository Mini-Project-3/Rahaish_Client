...
const Seachbar: FC<Props> = (props) => {
    return (
        ...
        <div className="w-full bg-gray-100 flex justify-center items-center">
            <div className="container mx-auto bg-secondary rounded-lg p-14">
                <form>
                    <h1 className="text-center font-bold text-green-900 text-3xl md:text-4xl pb-8">Welcome back, continue your home search</h1>
