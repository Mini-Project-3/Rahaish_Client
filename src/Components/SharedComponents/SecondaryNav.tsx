    ...
    return (
        <>
            <div className="h-12 bg-gray-100 flex justify-between px-7 items-center">
                ...
                <div className="">
                    <div>
                        <button onClick={() => setIsOpen(!isOpen)} className="flex space-x-2 text-gray-800  border-2 py-1  px-3 ml-5 rounded shadow bg-white"><h1 className="text-sm">MENU</h1>
                        ...
                        <div className=" absolute mt-2">{isOpen && <DropDown></DropDown>}</div>
                    </div>
                </div>
            </div>
