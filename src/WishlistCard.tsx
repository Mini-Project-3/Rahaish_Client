      ...
      <div className="p-10">
                <div className="lg:flex justify-center py-2 px-2 border-2 border-gray-300 shadow-2xl">
                    ...
                    <div className="lg:pl-0">
                        <div><img className="h-64 w-full" src="https://cdn.pixabay.com/photo/2017/08/10/05/06/condo-2618421__340.jpg" alt="" /></div>
                        <div className="flex mt-5" >
                            <div className="border-2 p-2 border-purple-300 text-4xl bg-purple-300 text-white">N</div>
                            <div className="mt-2.5 ml-4">
                                <div className="text-xl font-bold">Neev The Property Co...</div>
                    ...
                    <div>
                        <div className="lg:pl-8 pt-4 pb-4">
                            ...
                            <p className="text-gray-600">Vrindavan, Mathura</p>
                        </div>
                        <hr className="ml-5" />
                                ...
                                <div className="flex">
                                    <div className="flex">
                                       <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mt-1 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <p className="font-semibold ">55.08 L</p>
                                    </div>
                                </div>
                                    <p className="text-base text-gray-600">3,672 / sq ft</p></div>


                            <div><p className="font-semibold">1500</p>
                                <p className="text-base text-gray-600">Area in sq ft</p></div>
                            <div><p className="font-semibold">Under Construction</p>
                        ...
                        <div className="lg:pl-8 pt-4 pb-4">
                            <p >3 Bathrooms | New | East facing</p>
                            <div className="">
                                <p className="text-gray-600">3 BHK Property for Sale in Vrindavan Mathura: This is spacious 3 Bhk is available...<span className="text-red-700">MORE</span></p>
                            </div>
                        </div>
